...
const nyoutube = ('© clay\nChannel/rev? :\nhttps://youtube.com/channel/UCEXBWnblDig2QbtEEmnJSRg')  //ubah di config biar ngk emror
...
const sendStickerFromUrl = async(to, url) => {
      ...
      //Resize
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6285966393571-1616169743@g.us","inviteCode": "m","groupName": `${ytname}`, "caption": `${ytname}`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
...
//PEMBATAS ADMIN & OWNER=======================================
            ...
            case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: fs.readFileSync('./media/image/naze.jpg'), caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n*_Jika ingin berdonasi saya ucapkan terimakasih_*\n\n*_Jika ingin sewa bot atau premium_*\n*_Silahkan Chat Owner_*\n\n*_Atau klik link dibawah ini_*\n_https://trakteer.id/clayishere_\n\n*_Atau Transfer via_*\n*_Gopay Dana Ovo Qris ShopeePay_*\n_Ke nomer berikut : 6285966393571_\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/6285966393571')
            }
            break		 
            case 'subsyt': {
